...
/** GUI компрессора. */
public class GuiCompressor extends BaseGuiMachine {
    private final TileCompressor tile;
    public GuiCompressor(InventoryPlayer inv, TileCompressor tile) {
    ...
    @Override protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRenderer.drawString("Компрессор", 8, 6, 0x404040);
        fontRenderer.drawString("Энергия: " + tile.getStoredEnergy() + "/" + tile.getMaxEnergy() + " te", 8, 18, 0x00E060);
    }
    @Override protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        GL11.glColor4f(1F,1F,1F,1F);
        Minecraft.getMinecraft().renderEngine.bindTexture("/mods/technomod/textures/gui/guiCompressor.png");
